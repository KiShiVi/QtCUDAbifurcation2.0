...
int main()
{
	...
	bifurcation2D(
		...
		-7, //double in_paramValues1,
		1, //double in_paramValues2,
		18, //double in_paramValues3,
		30, //double in_paramValues4,
		0, //int in_nValue,
		...
		"C:\\CUDA\\My\\bif_CHEN_2d.csv", //std::string in_outPath,
		1, //bool in_debug,
